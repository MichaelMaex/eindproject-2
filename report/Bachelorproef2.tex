...
\todo{Afleiding vanuit conservatiewetten nodig?}
...
\begin{alignat}{3}
    ...
    &\frac{\partial}{\partial t}(\frac{p}{\rho^\gamma}) && &&= 0 \tag{energy}\label{eq:energy}.
\end{alignat} 
Here $\rho$ is the plasma density, $\mathbf B$ is the magnetic field,  $\mathbf v$ the velocity, $p$ is the thermal pressure.
