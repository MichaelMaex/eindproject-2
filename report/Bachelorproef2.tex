...
\begin{equation} \label{eq:linearised_mhd_5}
	\bigg(\omega^2 - \frac{(\mathbf{k \cdot B_0)^2}}{\mu\rho_0}\bigg)\mathbf{v_1} = \bigg[\bigg(\frac{\gamma p_0}{\rho_0}- \frac{\mathbf{B_0}^2}{\mu\rho_0}\bigg)\mathbf{k} - \frac{(\mathbf{k \cdot B_0)}}{\mu\rho_0}\mathbf{B_0}\bigg](\mathbf{k\cdot v_1}) - \frac{(\mathbf{k \cdot B_0})(\mathbf {v_1}\cdot \mathbf{B_0})}{\mu\rho_0}\mathbf{k}
\end{equation}
...
\begin{align*}
	...
	\end{pmatrix} \\
	 & + \begin{pmatrix} 
		 -k^2 (c_s^2 - 2v_a^2) \cos^2 \theta & - k^2 (c_s^2 - 2v_a^2) \cos\theta \sin \theta  & 0 \\
