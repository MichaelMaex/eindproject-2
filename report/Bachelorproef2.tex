...
\end{split}
\end{equation}
\Cref{fig:friedrich_diagrams} shows the fase speed of the slow, fast and alven waves for different ratios of $v_A / c_s$. 
\begin{figure}[h]
	\centering
\begin{tikzpicture}
...
\Cref{fig:groupspeed_beta} shows the group speed of the slow, fast and alv\'en waves for different values of the plasma-$\beta$
