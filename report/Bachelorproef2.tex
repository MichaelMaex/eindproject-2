...
<<<<<<< HEAD
When $\mu  = 10$ the magnetic pressure is dominant the alvèn waves are clearly visible.
\todo{comarison sound speed theoretical vs similation}
=======
When $\mu  = 10$ the magnetic pressure is dominant the alfv\'en waves are clearly visible.
\todo{comparison sound speed theoretical vs similation}
>>>>>>> 088b6a1c0ab2c5e0073360530be70e18905c5112
\begin{figure}[h]
	\centering
...
In the simulation above \cref{fig:Alfven_wave}, the magnetic field lies in the $x$-direction, hence the Alfv\'en wave is a one-dimensional wave, also in the $x$-direction. The theoretical speed of this wave is $v_A = \frac{B_0}{\sqrt{4\pi\rho_0}}$, comparing this to the velocity in the simulation gives,
