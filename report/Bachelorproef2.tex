...
\Cref{fig:blastwave_shape_beta} shows how the value of $\beta$ influences the shape of the blast wave. When $\beta$ is high, the blastwave resembles the one in ordinary non-magnetic hydrodynamics (\cref{fig:blastwave}).
\begin{figure}[H]
	\centering
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{figures/slowwave_time.pdf}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
