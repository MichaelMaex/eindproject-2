...
The parameter $\beta = \frac{B_0^2}{p}$ (in code units) gives the ratio of magnetic pressure over mechanical pressure. 
If $\beta = 0$ the magnetic field is $0$. 
If $\beta \gg 1$ the magnetic pressure dominates. 
